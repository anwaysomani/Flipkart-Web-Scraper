...
public class Laptops extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Gaming Laptop");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            File Flipkart = new File("C:\\Users\\LENOVO\\Desktop\\Flipkart\\Laptops");
            if (Flipkart.exists() && Flipkart.isDirectory()) {
                
            }
            else {
                new File("C:\\Users\\LENOVO\\Desktop\\Flipkart\\Laptops").mkdir();
            }
            
            FileWriter fw = new FileWriter("C:\\Users\\LENOVO\\Desktop\\Flipkart\\Laptops\\Gaming Laptop.doc");
            String loc = "C:\\Users\\LENOVO\\Desktop\\Flipkart\\Laptops\\Gaming Laptop.doc";
            Document doc = Jsoup.connect("https://www.flipkart.com/gaming-laptops-store?otracker=nmenu_sub_Electronics_0_Gaming%20Laptops&otracker=nmenu_sub_Electronics_0_Gaming%20Laptops").userAgent("Mozilla/17.0").get();
